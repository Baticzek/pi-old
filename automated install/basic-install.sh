...
FTLinstall() {
  ...
  latesttag=$(curl -sI https://github.com/pi-hole/FTL/releases/tags/v3.0 | grep "Location" | awk -F '/' '{print $NF}')
  ...
  if curl -sSL --fail "https://github.com/pi-hole/FTL/releases/download/v3.0/${latesttag%$'\r'}/${binary}" -o "${binary}"; then
    # get sha1 of the binary we just downloaded for verification.
    curl -sSL --fail "https://github.com/pi-hole/FTL/releases/download/v3.0${latesttag%$'\r'}/${binary}.sha1" -o "${binary}.sha1"
