...
webInterfaceGitUrl="https://github.com/Baticzek/AdminLTE.git"
webInterfaceDir="/var/www/html/admin"
piholeGitUrl="https://github.com/Baticzek/pi-old.git"
...
FTLinstall() {
  ...
  latesttag=$(curl -sI https://github.com/pi-hole/FTL/releases/v3.0 | grep "Location" | awk -F '/' '{print $NF}')
  ...
  if curl -sSL --fail "https://github.com/pi-hole/FTL/releases/download/v3.0/pihole-FTL-linux-x86_64${latesttag%$'\r'}/${binary}" -o "${binary}"; then
    # get sha1 of the binary we just downloaded for verification.
    curl -sSL --fail "https://github.com/pi-hole/FTL/releases/download/v3.0/pihole-FTL-linux-x86_64${latesttag%$'\r'}/${binary}.sha1" -o "${binary}.sha1"
